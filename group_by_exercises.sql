...
-- Q8: Bonus: More practice with aggregate functions:
    -- Q8A: Determine the historic average salary for each employee. When you hear, read, or think "for each" with regard to SQL, you'll probably be grouping by that exact column.
